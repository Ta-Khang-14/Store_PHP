...
<html lang="en">
    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="row path-banner">
                <img
                    src="./images/ps_cate_1646491417_912.jpg"
                    alt=""
                    class="col"
                />
            </div>
                ...
                <div class="col main-option">
                    <div class="main-option-wrapper">
                        ...
                        <ul class="main-list-option">
                            ...
                            <li class="main-list-option-item">
                                <a href="#">Bình nóng lạnh, máy lọc nước</a>
                                <i class="fa-solid fa-angle-down"></i>
                                <ul class="main-list-option-sub">
                                    <li>
                            ...
                            <li class="main-list-option-item">
                                ...
                                <ul class="main-list-option-sub">
                                    <li>
                                        <a href="">Tủ lạnh hai cánh</a>
                                    </li>
                                    <li><a href="">Tủ lạnh bốn cánh</a></li>
